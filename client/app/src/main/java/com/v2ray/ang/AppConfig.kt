...
object AppConfig {
    ...
    // Explicit profile launch is used only by the short-lived splash ad proxy. Normal VPN
    // launches continue to read the user's selected profile and remain backward compatible.
    const val EXTRA_TRANSIENT_PROFILE_GUID = "tornado.transient.PROFILE_GUID"
    const val EXTRA_TRANSIENT_ATTEMPT_ID = "tornado.transient.ATTEMPT_ID"
