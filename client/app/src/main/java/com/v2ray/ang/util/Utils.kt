...
object Utils {
    ...
    /**
     * Every dynamic receiver using this helper carries private control/status traffic between
     * Tornado processes. Keeping it non-exported prevents another installed app from forging
     * VPN START/STOP/RESTART and success/failure broadcasts.
     */
